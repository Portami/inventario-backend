...
public class BarcodeController {
    ...
    @Operation(summary = "Resolve a scanned barcode", description = "Looks up the entity attached to a Datamatrix code. The code is a numeric string, typically zero-padded (e.g. '00001'); padding is optional.")
    ...
    public ResponseEntity<BarcodeLookupDto> resolve(
            @Parameter(description = "Scanned barcode (numeric, zero-padding optional).", example = "00001") @PathVariable String code) {
