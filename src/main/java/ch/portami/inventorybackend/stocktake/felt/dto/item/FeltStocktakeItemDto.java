...
public record FeltStocktakeItemDto(
        ...
        @Schema(description =
                "The status the item, indicating whether it has been scanned and if there are any problems with it. Items with resolved problems keep their status, but have `needsResolution` set to false. The possible statuses are:<br/><br/> "
                        ...
                        + " - `MISSING`: The item is expected to be scanned but was not scanned yet. The storage where this item is expected is already closed. Possible resolutions are `REMOVE_MISSING` and `IGNORE_MISSING`<br/><br/> "
                        ...
                        + " - `NOT_IN_STOCKTAKE`: The item was scanned but is not part of the current stocktake, e.g. because it was not assigned to any storage at the time the stocktake was started, or because it was created after the stocktake was started. The problem has to be acknowledged (`ACKNOWLEDGE`).<br/><br/> "
